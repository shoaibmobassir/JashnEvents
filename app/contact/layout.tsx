...
export const metadata: Metadata = {
  ...
  description: 'Contact JASHN Events & Hospitality for professional event management services in Ara, Bhojpur, and Patna, Bihar. Phone: +91 7320877403 | Email: jashneventsinfo@gmail.com',
